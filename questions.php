...
<body class="d-flex flex-column h-100" style="background-color: #D7FDEC">
  ...
  <div class="container mt-sm-5 my-1">
    <main class="question ml-sm-5 pl-sm-5 pt-2">
      ...
      <div class="ml-md-3 ml-sm-3 pl-md-5 pt-sm-0 pt-3" id="options">Your answer:</h7>
        <form style="width:auto;" class="form-select containerq"
          onsubmit="return validateForm();" action="<?php echo $link; ?>" method="post">
          <?php
          ...
          echo '<img src="/images' . $question["image"] . '" width="400px"></img>'; 
